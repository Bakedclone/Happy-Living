...
export const dashboardData = catchAsyncError(async (req, res, next) => {
    ...
    async function getTotalRemainingCapacity() {
        ...
        try {
            ...
            console.log("Total remaining capacity:", totalRemainingCapacity);
